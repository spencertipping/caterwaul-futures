...
caterwaul.js_all()(function ($) {
  ...
  where [callback_future()             = calls_its_send_method() -se- caterwaul.merge(it, future_initials_for(it), future_operations_for(it))
         ...
         future_operations_for(future) = wcapture [push(f)              = future            -se- future.listeners.push(f)
                                                   ...
                                                   send(xs = arguments) = future -se [it.decided = xs] -se- future.trigger(future.listeners, xs)]]})(caterwaul);
