...
return{listeners: [ ] ,decided:null} } ,future_operations_for=function(future) {;
...
return(function(it) {return(push(function(_) {return( (f(_) ) && (it(_) ) ) } ) ) ,it} ) .call(this, (caterwaul_future() ) ) } ;
